export const responseTemplate = `<samlp:Response xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" ID="{respId}" InResponseTo="{inResponseTo}" Version="2.0" IssueInstant="{issueTime}" Destination="{destination}">
...
export const assertionTemplate = `<saml:Assertion xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" Version="2.0" ID="{assertId}" IssueInstant="{issueTime}">
...
export const logoutRequestTemplate = `<samlp:LogoutRequest xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" ID="{id}" Version="2.0" IssueInstant="{issueTime}" Destination="{logoutUrl}" Consent="urn:oasis:names:tc:SAML:2.0:consent:unspecified">
	<Issuer xmlns="urn:oasis:names:tc:SAML:2.0:assertion">{issuer}</Issuer>
	<NameID xmlns="urn:oasis:names:tc:SAML:2.0:assertion" Format="urn:oasis:names:tc:SAML:1.1:nameid-format:unspecified">ENTER_NAME_ID_HERE</NameID>
	<samlp:SessionIndex>ENTER_SESSION_INDEX_HERE</samlp:SessionIndex>
</samlp:LogoutRequest>`

export const logoutResponseTemplate = `<samlp:LogoutResponse xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" ID="{id}" InResponseTo="{inResponseTo}" Version="2.0" IssueInstant="{issueTime}" Destination="{callbackUrl}">
	<saml:Issuer xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion">{issuer}</saml:Issuer>
	<samlp:Status>
		<samlp:StatusCode Value="urn:oasis:names:tc:SAML:2.0:status:Success"/>
	</samlp:Status>
