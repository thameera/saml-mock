export const responseTemplate = `<samlp:Response xmlns:samlp="urn:oasis:names:tc:SAML:2.0:protocol" ID="5678" InResponseTo="{inResponseTo}" Version="2.0" IssueInstant="{issueTime}" Destination="{destination}">
...
export const assertionTemplate = `<saml:Assertion xmlns:saml="urn:oasis:names:tc:SAML:2.0:assertion" Version="2.0" ID="1234" IssueInstant="{issueTime}">
	...
	<saml:Subject>
		...
		<saml:SubjectConfirmation Method="urn:oasis:names:tc:SAML:2.0:cm:bearer">
			<saml:SubjectConfirmationData NotOnOrAfter="{expiryTime}" Recipient="{redirectUrl}" InResponseTo="{inResponseTo}"/>
		</saml:SubjectConfirmation>
	</saml:Subject>
	<saml:Conditions NotBefore="{issueTime}" NotOnOrAfter="{expiryTime}">
		<saml:AudienceRestriction>
			<saml:Audience>urn:auth0:tham:Tham-SAML-IDP</saml:Audience>
		</saml:AudienceRestriction>
	</saml:Conditions>
